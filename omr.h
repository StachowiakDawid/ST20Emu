...
#define HP_TIMER_TICK                                                                              \
  (CPU_CLOCK / (15625 * 64)) // 1000000 ticks per sec (1Mhz=15625*64), complete a cycle in 60'
static long hp_timertick = HP_TIMER_TICK; //(~61 cpu cycles = 1 tick)
#endif
#ifndef LP_TIMER_TICK
#define LP_TIMER_TICK                                                                              \
  (CPU_CLOCK / 15625) // 15625 ticks per sec (15,625Khz), complete a cycle in 76hour
