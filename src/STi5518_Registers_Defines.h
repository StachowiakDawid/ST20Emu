...
#define VID_LCK                                                                                    \
  0x0000007b // bits:1 Access:R/W DESCR:Locks registers VID_CFG_MCF, VID_CFG_CCF and VID_CFG_DRC
#define VID_TP_SCD_RD_15_8                                                                         \
  0x00000081 // bits:8 Access:RO DESCR:Read only SCD pointer VLD load address
#define VID_TP_SCD_RD_7_0                                                                          \
  0x00000082 // bits:8 Access:RO DESCR:Read only SCD pointer VLD load address
...
#define VID_TP_VLD_RD_19_16                                                                        \
  0x000000c3 // bits:4 Access:RO DESCR:Read only VLD pointer current address
#define VID_TP_VLD_RD_15_8                                                                         \
  0x000000c4                         // bits:8 Access:RO DESCR:Read only VLD pointer current address
...
#define VID_TP_SCD_CURRENT_19_16                                                                   \
  0x000000cd // bits:4 Access:RO DESCR:Read only SCD pointer current address
#define VID_TP_SCD_CURRENT_15_8                                                                    \
  0x000000ce // bits:8 Access:RO DESCR:Read only SCD pointer current address
#define VID_TP_SCD_CURRENT                                                                         \
  0x000000cf                         // bits:8 Access:RO DESCR:Read only SCD pointer current address
...
#define VID_CMOD                                                                                   \
  0x000000ea // bits:40 Access:R/W DESCR:to->0x000000EE Configure chrominance of block-row
#define VID_YMOD                                                                                   \
  0x000000ef // bits:40 Access:R/W DESCR:to->0x000000F3 Configure luminance of block-row
...
#define CKG_SFREQSMC_PE0                                                                           \
  0x000001d7 // bits:8 Access:R/W DESCR:PE reg (LSB): SMC frequency synthesizer
#define CKG_SFREQSMC_PE1                                                                           \
  0x000001d8 // bits:8 Access:R/W DESCR:PE reg (MSB): SMC frequency synthesizer
...
#define CKG_PLLSETUP                                                                               \
  0x000001e2 // bits:6 Access:R/W DESCR:PLL start-up control and charge pump control
...
#define CKG_SFREQAUD_PE0                                                                           \
  0x000001e5 // bits:8 Access:R/W DESCR:PE reg (LSB): AUD frequency synthesizer
#define CKG_SFREQAUD_PE1                                                                           \
  0x000001e6 // bits:8 Access:R/W DESCR:PE reg (MSB): AUD frequency synthesizer
#define CKG_SFREQAUD_MD 0x000001e7 // bits:5 Access:R/W DESCR:MD reg: AUD frequency synthesizer
#define CKG_AUD_CNT                                                                                \
  0x000001e8 // bits:1 Access:R/W DESCR:Sets audio frequency control through ST20 or MMDSP
#define CKG_SFREQAUX_SDIV 0x000001e9 // bits:3 Access:R/W DESCR:SDIV reg: AUX frequency synthesizer
#define CKG_SFREQAUX_PE0                                                                           \
  0x000001ea // bits:8 Access:R/W DESCR:PE reg (LSB): AUX frequency synthesizer
#define CKG_SFREQAUX_PE1                                                                           \
  0x000001eb // bits:8 Access:R/W DESCR:PE reg (MSB): AUX frequency synthesizer
...
#define AUD_LDLY_TM_SPEED                                                                          \
  0x00000257                        // bits:8 Access:R/W DESCR:Left channel - Audio trick-mode speed
...
#define AUD_PCM_BTONE                                                                              \
  0x00000268 // bits:8 Access:R/W DESCR:PCM beep tone frequency - Decode LFE for AC3 setup - Channel
             // skip for MPEG setup
#define AUD_COMP_MOD                                                                               \
  0x00000269 // bits:8 Access:R/W DESCR:Compression mode for AC3 setup - Program number for MPEG
             // setup
#define AUD_AC3_HDR                                                                                \
  0x0000026a // bits:8 Access:R/W DESCR:High dynamic range for AC3 setup - High dynamic range for
             // MPEG setup
#define AUD_AC3_LDR 0x0000026b // bits:8 Access:R/W DESCR:Low dynamic range
#define AUD_AC3_CRC_OFF                                                                            \
  0x0000026c // bits:8 Access:R/W DESCR:Repeat count for AC3 setup - CRC check-off for MPEG setup
#define AUD_AC3_KARAMODE                                                                           \
  0x0000026d // bits:8 Access:R/W DESCR:Karaoke downmix for AC3 setup - Multichannel for MPEG setup
#define AUD_AC3_DUALMODE                                                                           \
  0x0000026e // bits:8 Access:R/W DESCR:Dual downmix for AC3 setup - Dual downmix for MPEG setup
#define AUD_AC3_DOWNMIX                                                                            \
  0x0000026f // bits:8 Access:R/W DESCR:Downmix for AC3 setup - Downmix for MPEG setup
...
#define AUD_SKIP_MUTE_VALUE                                                                        \
  0x00000274 // bits:8 Access:R/W DESCR:Skip frames or mutes blocks of frame
#define AUD_SPDIF_REP_TIME                                                                         \
  0x00000275 // bits:8 Access:R/W DESCR:IEC958 repetition time of a pause frame
#define AUD_STATUS0                                                                                \
  0x00000276 // bits:8 Access:RO DESCR:AC-3 status register 0 - MPEG status register0
#define AUD_STATUS1                                                                                \
  0x00000277 // bits:4 Access:RO DESCR:AC-3 status register 1 - MPEG status register1
#define AUD_STATUS2                                                                                \
  0x00000278 // bits:8 Access:RO DESCR:AC-3 status register 2 - MPEG status register2
#define AUD_STATUS3                                                                                \
  0x00000279 // bits:4 Access:RO DESCR:AC-3 status register 3 - MPEG status register3
#define AUD_STATUS4                                                                                \
  0x0000027a // bits:5 Access:RO DESCR:AC-3 status register 4 - MPEG status register4
#define AUD_STATUS5                                                                                \
  0x0000027b // bits:8 Access:RO DESCR:AC-3 status register 5 - MPEG status register5
...
#define DEN_IDFS1                                                                                  \
  0x0000060a // bits:8 Access:R/W DESCR:DENC Increment for Digital Frequency Synthesizer
#define DEN_IDFS2                                                                                  \
  0x0000060b // bits:8 Access:R/W DESCR:DENC Increment for Digital Frequency Synthesizer
#define DEN_IDFS3                                                                                  \
  0x0000060c // bits:8 Access:R/W DESCR:DENC Increment for Digital Frequency Synthesizer
#define DEN_PDFS1                                                                                  \
  0x0000060d // bits:8 Access:R/W DESCR:Static phase offset for digital frequency synthesizer
#define DEN_PDFS2                                                                                  \
  0x0000060e // bits:8 Access:R/W DESCR:Static phase offset for digital frequency synthesizer
...
#define DEN_CCF1                                                                                   \
  0x00000627 // bits:8 Access:R/W DESCR:Closed caption characters/extended data for field 1
#define DEN_CCF1B                                                                                  \
  0x00000628 // bits:8 Access:R/W DESCR:Closed caption characters/extended data for field 1
#define DEN_CCF2                                                                                   \
  0x00000629 // bits:8 Access:R/W DESCR:Closed caption characters/extended data for field 2
#define DEN_CCF2B                                                                                  \
  0x0000062a // bits:8 Access:R/W DESCR:Closed caption characters/extended data for field 2
#define DEN_CLF1                                                                                   \
  0x0000062b // bits:5 Access:R/W DESCR:Closed caption/extended data line insert for field 1
#define DEN_CLF2                                                                                   \
  0x0000062c // bits:5 Access:R/W DESCR:Closed caption/extended data line insert for field 2
...
#define MPEG_CONTROL_7_0                                                                           \
  0x00000e00 // bits:8 Access:R/W DESCR:MPEG Audio/Video buffer control register
#define MPEG_CONTROL_14_8                                                                          \
  0x00000e01 // bits:8 Access:R/W DESCR:MPEG Audio/Video buffer control register
#define EMI_CONFIGDATA0BANK0                                                                       \
  0x00002000 // bits:16 Access:R/W DESCR:EMI bank 0 configuration data register 0 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA1BANK0                                                                       \
  0x00002004 // bits:16 Access:R/W DESCR:EMI bank 0 configuration data register 1 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA2BANK0                                                                       \
  0x00002008 // bits:16 Access:R/W DESCR:EMI bank 0 configuration data register 2 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA3BANK0                                                                       \
  0x0000200c // bits:16 Access:R/W DESCR:EMI bank 0 configuration data register 3 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA0BANK1                                                                       \
  0x00002010 // bits:16 Access:R/W DESCR:EMI bank 1 configuration data register 0 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA1BANK1                                                                       \
  0x00002014 // bits:16 Access:R/W DESCR:EMI bank 1 configuration data register 1 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA2BANK1                                                                       \
  0x00002018 // bits:16 Access:R/W DESCR:EMI bank 1 configuration data register 2 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA3BANK1                                                                       \
  0x0000201c // bits:16 Access:R/W DESCR:EMI bank 1 configuration data register 3 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA0BANK2                                                                       \
  0x00002020 // bits:16 Access:R/W DESCR:EMI bank 2 configuration data register 0 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA1BANK2                                                                       \
  0x00002024 // bits:16 Access:R/W DESCR:EMI bank 2 configuration data register 1 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA2BANK2                                                                       \
  0x00002028 // bits:16 Access:R/W DESCR:EMI bank 2 configuration data register 2 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA3BANK2                                                                       \
  0x0000202c // bits:16 Access:R/W DESCR:EMI bank 2 configuration data register 3 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA0BANK3                                                                       \
  0x00002030 // bits:16 Access:R/W DESCR:EMI bank 3 configuration data register 0 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA1BANK3                                                                       \
  0x00002034 // bits:16 Access:R/W DESCR:EMI bank 3 configuration data register 1 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA2BANK3                                                                       \
  0x00002038 // bits:16 Access:R/W DESCR:EMI bank 3 configuration data register 2 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGDATA3BANK3                                                                       \
  0x0000203c // bits:16 Access:R/W DESCR:EMI bank 3 configuration data register 3 SDRAM, DRAM and
             // peripheral memory formats
#define EMI_CONFIGLOCKBANK0                                                                        \
  0x00002040 // bits:1 Access:W DESCR:Write protection bit. When set, makes EMI_ConfigData 0-3 for
             // Bank0 read only
#define EMI_CONFIGLOCKBANK0                                                                        \
  0x00002044 // bits:1 Access:W DESCR:Write protection bit. When set, makes EMI_ConfigData 0-3 for
             // Bank1 read only
#define EMI_CONFIGLOCKBANK0                                                                        \
  0x00002048 // bits:1 Access:W DESCR:Write protection bit. When set, makes EMI_ConfigData 0-3 for
             // Bank2 read only
#define EMI_CONFIGLOCKBANK0                                                                        \
  0x0000204c // bits:1 Access:W DESCR:Write protection bit. When set, makes EMI_ConfigData 0-3 for
             // Bank3 read only
#define EMI_CONFIGSTATUS 0x00002050 // bits:8 Access:R DESCR:Status information
#define EMI_SDRAMMODEREG0                                                                          \
  0x00002058 // bits:7 Access:W DESCR:SDRAM Mode Register for either the case of one SDRAM bank or
             // SDRAM in bank0, when two SDRAM banks.
...
#define EMI_CONFIGPADLOGIC                                                                         \
  0x00002070           // bits:14 Access:R/W DESCR:Padlogic configuration data register.
#define DCU 0x00003004 // bits:8 Access:R/W DESCR:Diagnostic Control Unit Register.
#define CAC_CACHECONTROL0                                                                          \
  0x00004000 // bits:8 Access:R/W DESCR:Cacheability of 0xC0000000 to 0xC007FFFF
#define CAC_CACHECONTROL1                                                                          \
  0x00004100 // bits:8 Access:R/W DESCR:Cacheability of 0xC0200000 to 0xC027FFFF
#define CAC_CACHECONTROL2                                                                          \
  0x00004200 // bits:8 Access:R/W DESCR:Cacheability of 0x40000000 to 0x4007FFFF
#define CAC_CACHECONTROL3                                                                          \
  0x00004300 // bits:4 Access:R/W DESCR:Cacheability of 0x40000000 to 0x7FFFFFFF
...
#define INC_HANDLERWPTR0                                                                           \
  0x20000000 // bits:32 Access:R/W DESCR:Interrupt handler 0 work space pointer
#define INC_HANDLERWPTR1                                                                           \
  0x20000004 // bits:32 Access:R/W DESCR:Interrupt handler 1 work space pointer
#define INC_HANDLERWPTR2                                                                           \
  0x20000008 // bits:32 Access:R/W DESCR:Interrupt handler 2 work space pointer
#define INC_HANDLERWPTR3                                                                           \
  0x2000000c // bits:32 Access:R/W DESCR:Interrupt handler 3 work space pointer
#define INC_HANDLERWPTR4                                                                           \
  0x20000010 // bits:32 Access:R/W DESCR:Interrupt handler 4 work space pointer
#define INC_HANDLERWPTR5                                                                           \
  0x20000014 // bits:32 Access:R/W DESCR:Interrupt handler 5 work space pointer
#define INC_HANDLERWPTR6                                                                           \
  0x20000018 // bits:32 Access:R/W DESCR:Interrupt handler 6 work space pointer
#define INC_HANDLERWPTR7                                                                           \
  0x2000001c // bits:32 Access:R/W DESCR:Interrupt handler 7 work space pointer
...
#define ASC_0_GUARDTIME                                                                            \
  0x20003018 // bits:8 Access:R/W DESCR:ASC 0 Delay before transmitter empty flag
...
#define ASC_1_GUARDTIME                                                                            \
  0x20004018 // bits:8 Access:R/W DESCR:ASC 1 Delay before transmitter empty flag
...
#define ASC_2_GUARDTIME                                                                            \
  0x20005018 // bits:8 Access:R/W DESCR:ASC 2 Delay before transmitter empty flag
...
#define ASC_3_GUARDTIME                                                                            \
  0x20006018 // bits:8 Access:R/W DESCR:ASC 3 Delay before transmitter empty flag
...
#define IRB_RX_MAX_SYM_TIME_IR                                                                     \
  0x2000a254                             // bits:16 Access:W/R DESCR:Maximum RC symbol time register
...
#define IRB_RX_SAMPLING_RATE_COMMON                                                                \
  0x2000a264 // bits:4 Access:W/R DESCR:Sampling frequency division for UHF and IR frequencies.
...
#define IRB_RX_MAX_SYM_TIME_UHF                                                                    \
  0x2000a294 // bits:16 Access:W/R DESCR:Maximum RC symbol time register
#define IRB_RX_CLR_OVERRUN_UHF 0x2000a298 // bits:1 Access:W DESCR:Clears the overrun status
#define IRB_RX_NOISE_SUPPRESS_WIDTH_UHF                                                            \
  0x2000a29c                          // bits:8 Access:W/R DESCR:Noise suppression width
...
#define INC_INT20PRIORITY                                                                          \
  0x20011050 // bits:3 Access: R/W DESCR:Internal interrupt 20 priority (reserved)
#define INC_INT21PRIORITY                                                                          \
  0x20011054 // bits:3 Access: R/W DESCR:Internal interrupt 21 priority (reserved)
#define INC_INT22PRIORITY                                                                          \
  0x20011058 // bits:3 Access: R/W DESCR:Internal interrupt 22 priority (reserved)
#define INC_INT23PRIORITY                                                                          \
  0x2001105c // bits:3 Access: R/W DESCR:Internal interrupt 23 priority (reserved)
...
#define INC_SRC20_TRIGGERMODE                                                                      \
  0x2001110c // bits:3 Access:R/W DESCR:Interrupt source 20 trigger mode (reserved)
#define INC_SRC21_TRIGGERMODE                                                                      \
  0x20011110 // bits:3 Access:R/W DESCR:Interrupt source 21 trigger mode (reserved)
#define INC_SRC22_TRIGGERMODE                                                                      \
  0x20011114 // bits:3 Access:R/W DESCR:Interrupt source 22 trigger mode (reserved)
#define INC_SRC23_TRIGGERMODE                                                                      \
  0x20011118 // bits:3 Access:R/W DESCR:Interrupt source 23 trigger mode (reserved)
#define INC_SRC24_TRIGGERMODE                                                                      \
  0x2001111c // bits:3 Access:R/W DESCR:External interrupt source 0 trigger mode
#define INC_SRC25_TRIGGERMODE                                                                      \
  0x20011120 // bits:3 Access:R/W DESCR:External interrupt source 1 trigger mode
#define INC_SRC26_TRIGGERMODE                                                                      \
  0x20011124 // bits:3 Access:R/W DESCR:External interrupt source 2 trigger mode
#define INC_SRC27_TRIGGERMODE                                                                      \
  0x20011128 // bits:3 Access:R/W DESCR:External interrupt source 3 trigger mode
#define INC_SRC28_TRIGGERMODE                                                                      \
  0x2001112c // bits:3 Access:R/W DESCR:External interrupt source 4 trigger mode
#define INC_SRC29_TRIGGERMODE                                                                      \
  0x20011130 // bits:3 Access:R/W DESCR:External interrupt source 5 trigger mode
#define INC_SRC30_TRIGGERMODE                                                                      \
  0x20011134 // bits:3 Access:R/W DESCR:External interrupt source 6 trigger mode
#define INC_SRC_CLEAR_MASK                                                                         \
  0x200111b4                        // bits:31 Access:W DESCR:Clear interrupt-source enable register
...
#define INC_SELNOTINV                                                                              \
  0x200111c8 // bits:3 Access:R/W DESCR:External interrupt pin is set to active high or active low
#define INC_EN_INT                                                                                 \
  0x200111cc // bits:3 Access:R/W DESCR:Enable external interrupt to wake-up the low-power
             // controller
#define INC_SRC_STATUS                                                                             \
  0x200111dc // bits:31 Access:R DESCR:Gives the latched status of an interrupt source
#define INC_SRC_CLEAR 0x200111ec // bits:31 Access:R DESCR:Clears the INC_SRC_STATUS register
#define MPEGDMA0_BURSTSIZE                                                                         \
  0x20024000 // bits:5 Access:W DESCR:The number of bytes to be transferred in one burst
#define MPEGDMA0_HOLDOFF                                                                           \
  0x20024004 // bits:5 Access:W DESCR:Holdoff for MPEG decoder: range 0 to 31, where 0=0 delay
             // cycles
...
#define MPEGDMA1_BURSTSIZE                                                                         \
  0x20025000 // bits:5 Access:W DESCR:The number of bytes to be transferred in one burst
#define MPEGDMA1_HOLDOFF                                                                           \
  0x20025004 // bits:5 Access:W DESCR:Holdoff for MPEG decoder: range 0 to 31, where 0=0 delay
             // cycles
...
#define MOD_RECEIVE0_POINTER                                                                       \
  0x20027020 // bits:30 Access:R/W DESCR:Receive_memory_buffer_0 start address
#define MOD_RECEIVE1_POINTER                                                                       \
  0x20027024 // bits:30 Access:R/W DESCR:Receive_memory_buffer_1 start address
#define MOD_TRANSMIT0_POINTER                                                                      \
  0x20027028 // bits:30 Access:R/W DESCR:Transmit_memory_buffer_0 start address
#define MOD_TRANSMIT1_POINTER                                                                      \
  0x2002702c                 // bits:30 Access:R/W DESCR:Transmit_memory_buffer_1 start address
...
#define LNK_STREAM_FRAM                                                                            \
  0x200384fc // bits:32 Access:R/W DESCR:End of Filter Data (FRAM) register - 320words from
             // LNKBaseAddress
#define LNK_STREAM1_CONF1                                                                          \
  0x20038580 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF2                                                                          \
  0x20038584 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF3                                                                          \
  0x20038588 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF4                                                                          \
  0x2003858c // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF5                                                                          \
  0x20038590 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF6                                                                          \
  0x20038594 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF7                                                                          \
  0x20038598 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF8                                                                          \
  0x2003859c // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF9                                                                          \
  0x200385a0 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF10                                                                         \
  0x200385a4 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF11                                                                         \
  0x200385a8 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF12                                                                         \
  0x200385ac // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF13                                                                         \
  0x200385b0 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF14                                                                         \
  0x200385b4 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF15                                                                         \
  0x200385b8 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF16                                                                         \
  0x200385bc // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF17                                                                         \
  0x200385c0 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF18                                                                         \
  0x200385c4 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF19                                                                         \
  0x200385c8 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF20                                                                         \
  0x200385cc // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF21                                                                         \
  0x200385d0 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF22                                                                         \
  0x200385d4 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF23                                                                         \
  0x200385d8 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF24                                                                         \
  0x200385dc // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF25                                                                         \
  0x200385e0 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF26                                                                         \
  0x200385e4 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF27                                                                         \
  0x200385e8 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF28                                                                         \
  0x200385ec // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF29                                                                         \
  0x200385f0 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF30                                                                         \
  0x200385f4 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF31                                                                         \
  0x200385f8 // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM1_CONF32                                                                         \
  0x200385fc // bits:32 Access:R/W DESCR:Stream Configuration #1 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF1                                                                          \
  0x20038600 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF2                                                                          \
  0x20038604 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF3                                                                          \
  0x20038608 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF4                                                                          \
  0x2003860c // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF5                                                                          \
  0x20038610 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF6                                                                          \
  0x20038614 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF7                                                                          \
  0x20038618 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF8                                                                          \
  0x2003861c // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF9                                                                          \
  0x20038620 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF10                                                                         \
  0x20038624 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF11                                                                         \
  0x20038628 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF12                                                                         \
  0x2003862c // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF13                                                                         \
  0x20038630 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF14                                                                         \
  0x20038634 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF15                                                                         \
  0x20038638 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF16                                                                         \
  0x2003863c // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF17                                                                         \
  0x20038640 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF18                                                                         \
  0x20038644 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF19                                                                         \
  0x20038648 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF20                                                                         \
  0x2003864c // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF21                                                                         \
  0x20038650 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF22                                                                         \
  0x20038654 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF23                                                                         \
  0x20038658 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF24                                                                         \
  0x2003865c // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF25                                                                         \
  0x20038660 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF26                                                                         \
  0x20038664 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF27                                                                         \
  0x20038668 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF28                                                                         \
  0x2003866c // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF29                                                                         \
  0x20038670 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF30                                                                         \
  0x20038674 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF31                                                                         \
  0x20038678 // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM2_CONF32                                                                         \
  0x2003867c // bits:32 Access:R/W DESCR:Stream Configuration #2 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF1                                                                          \
  0x20038680 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF2                                                                          \
  0x20038684 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF3                                                                          \
  0x20038688 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF4                                                                          \
  0x2003868c // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF5                                                                          \
  0x20038690 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF6                                                                          \
  0x20038694 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF7                                                                          \
  0x20038698 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF8                                                                          \
  0x2003869c // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF9                                                                          \
  0x200386a0 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF10                                                                         \
  0x200386a4 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF11                                                                         \
  0x200386a8 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF12                                                                         \
  0x200386ac // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF13                                                                         \
  0x200386b0 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF14                                                                         \
  0x200386b4 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF15                                                                         \
  0x200386b8 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF16                                                                         \
  0x200386bc // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF17                                                                         \
  0x200386c0 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF18                                                                         \
  0x200386c4 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF19                                                                         \
  0x200386c8 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF20                                                                         \
  0x200386cc // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF21                                                                         \
  0x200386d0 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF22                                                                         \
  0x200386d4 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF23                                                                         \
  0x200386d8 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF24                                                                         \
  0x200386dc // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF25                                                                         \
  0x200386e0 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF26                                                                         \
  0x200386e4 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF27                                                                         \
  0x200386e8 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF28                                                                         \
  0x200386ec // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF29                                                                         \
  0x200386f0 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF30                                                                         \
  0x200386f4 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF31                                                                         \
  0x200386f8 // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
#define LNK_STREAM3_CONF32                                                                         \
  0x200386fc // bits:32 Access:R/W DESCR:Stream Configuration #3 (see pag.176 Reg.Man.)
...
#define FEI_DEC_IDX_STA                                                                            \
  0x20038784 // bits:6 Access:R/W DESCR:[WO:6]Decryption Cell Register - Index [RO:2]Decryption Cell
             // Register - Status
#define FEI_SUB                                                                                    \
  0x20038788 // bits:16 Access:RO DESCR:Contents the 16 bits subcode value from the subcode FIFO
#define FEI_SFF                                                                                    \
  0x2003878c // bits:8 Access:RO DESCR:Indicates the actual filling level of the subcode FIFO
#define FEI_GCF 0x20038790 // bits:16 Access:RO DESCR:Module Configuration Flags
#define FEI_SLG                                                                                    \
  0x20038798 // bits:16 Access:R/W DESCR:Only used when data are input using the parallel interface
...
#define FEI_SE_CAP_H                                                                               \
  0x20038820 // bits:8 Access:R/W DESCR:Address of first sector /subcode block to be captured
#define FEI_SE_CAP_L                                                                               \
  0x20038824 // bits:8 Access:R/W DESCR:Address of first sector /subcode block to be captured
#define FEI_SE_LST_H                                                                               \
  0x20038828 // bits:8 Access:R/W DESCR:Address of (last + 1) sector /subcode block to be captured
#define FEI_SE_LST_L                                                                               \
  0x2003882c // bits:16 Access:R/W DESCR:Address of (last + 1) sector/subcode block to be captured
#define FEI_SE_CUR_H                                                                               \
  0x20038830 // bits:8 Access:RO DESCR:Address of sector/subcode block actually entering the SP
#define FEI_SE_CUR_L                                                                               \
  0x20038834 // bits:16 Access:RO DESCR:Address of sector /subcode block entering the SP
#define FEI_SE_HE_H                                                                                \
  0x20038860 // bits:16 Access:R/W DESCR:CPR_MAI Bits of Current Sector actually entering the SP
#define FEI_SE_HE_M                                                                                \
  0x20038864 // bits:16 Access:R/W DESCR:CPR_MAI Bits of Current Sector actually entering the SP
#define FEI_SE_HE_L                                                                                \
  0x20038868 // bits:16 Access:R/W DESCR:CPR_MAI Bits of Current Sector actually entering the SP
