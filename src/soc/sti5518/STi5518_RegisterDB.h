...
static REGDESCR DBREGS_Entry[] = {
    ...
    {"OGT_XDI", SubPictureBaseAddress + 0x000044, 2, "R/W",
     "Active area horizontal position offset"},
    {"OGT_XDI", SubPictureBaseAddress + 0x000045, 8, "R/W",
     "Active area horizontal position offset"},
    ...
    {"OGT_HL2XO", SubPictureBaseAddress + 0x000048, 2, "R/W",
     "Active area vertical position offset"},
    {"OGT_HL2XO", SubPictureBaseAddress + 0x000049, 8, "R/W",
     "Active area vertical position offset"},
    ...
    {"IRB_RX_SAMPLING_RATE_COMMON", IRBBaseAddress + 0x64, 4, "W/R",
    ...
    {"IRB_RX_MAX_SYM_TIME_UHF", IRBBaseAddress + 0x94, 16, "W/R",
