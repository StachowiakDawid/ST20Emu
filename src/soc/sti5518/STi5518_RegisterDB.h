...
inline constexpr std::array<RegisterDescription, 1045> db_regs_entries = {
    {// VIDEO DECODER (VID)
     ...
     {"AUD_PCM_BTONE", 0x00000268, 8, "R/W",
     ...
     {"FEI_DEC_IDX_STA", 0x20038784, 6, "R/W",
      "[WO:6]Decryption Cell Register - Index [RO:2]Decryption Cell Register - Status"},
